...
class WebScraper:
    ...
    columnCaptionsImmo = ['Size', 'Number of Rooms', 'Price', 'Street', 'Zip Code', 'City', 'State']
    jsonKeyValuesImmo = [['surfaceLiving'],
                         ['numberOfRooms'],
                         ['grossPrice'],
                         ['street'],
                         ['zip'],
    ...
    columnCaptionsHome = ['Size', 'Number of Rooms', 'Price', 'Street', 'Zip Code', 'City']
